...
func (service *service) upgradeDocker(environment *portainer.Endpoint, licenseKey, version string) error {
	ctx := context.TODO()

	envType := CheckDockerEnvTypeForUpgrade(environment)
...
func CheckDockerEnvTypeForUpgrade(environment *portainer.Endpoint) string {
